...
public class Client implements Serializable {
	...
	public String toTable() {
		return "</td></tr><tr><td>" + idclient + " </td><td>" + name + "</td><td> " + surname
				...
				+ "<a href='dispatcherReserva?idReserva="+this.getIdclient()+"'><button>MODIFICAR</button></a>" + "</td><td>" + "<a href='dispatcherReservaBorrar?idReserva="+this.getIdclient()+"'><button>ELIMINAR</button></a>";
	}
